...
<body>
    ...
    <section id="carouselExampleControls" class="carousel slide carousel_section" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="carousel-image" src="./image/cmpd1.jpg">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/livingroomtwo.jpg">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/mastertwo.jpg">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/Masterroom.jpg">
            </div>
        </div>
    </section>
    ...
    <section id="auth_section">
        ...
        <div class="logo">
            <img class="hsa" src="./image/hsa.png" alt="logo">
            <p>Amangee Luxury Apartments</p>
        </div>
